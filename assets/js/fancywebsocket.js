...
function actualiza_mensaje(message)
{
	var JSONdata    = JSON.parse(message); //parseo la informacion
				...
				var mensajehtml   = '<div class="row msg_container base_send"><div class="col-md-10 col-xs-10"><div class="messages_sent msg_sent"><p>'+mensaje+'</p><time datetime="2009-11-13T20:00">'+fecha+'</time><div class="col-md-10 col-xs-10 avatar"></div></div><!--<img src="http://www.bitrebels.com/wp-content/uploads/2011/02/Original-Facebook-Geek-Profile-Avatar-1.jpg" class=" img-responsive "></div>--></div>';
